...
- Use feature branches and submit pull requests for review before merging.
- Code reviews are a must before merging into main.
- Code must be 85% or above unit tested and all tests must pass
...
By agreeing to this Working Agreement, each team member are commited to following these guidelines.
